...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Demos — Live Country Demographics" },
      { name: "description", content: "Explore live and recent demographic statistics for every country in the world." },
      { property: "og:title", content: "Demos — Live Country Demographics" },
      { name: "twitter:title", content: "Demos — Live Country Demographics" },
